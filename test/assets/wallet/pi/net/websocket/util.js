...
var charToUtf8 = function charToUtf8(c) {
    ...
    if (c < 0) {
        ...
        // 16#800---110xxxxx 10xxxxxx
        // tslint:disable:binary-expression-operand-order
        r = [192 + (c >> 6), 128 + (c & 63)];
    } else if (c < 65536) {
        // 16#10000---1110xxxx 10xxxxxx 10xxxxxx
        r = [224 + (c >> 12), 128 + (c >> 6 & 63), 128 + (c & 63)];
    } else if (c < 2097152) {
        // 16#200000---11110xxx 10xxxxxx 10xxxxxx 10xxxxxx
        r = [240 + (c >> 18), 128 + (c >> 12 & 63), 128 + (c >> 6 & 63), 128 + (c & 63)];
    } else if (c < 67108864) {
        // 16#400 0000---111110xx 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx
        r = [248 + (c >> 24), 128 + (c >> 18 & 63), 128 + (c >> 12 & 63), 128 + (c >> 6 & 63), 128 + (c & 63)];
    } else if (c < 2147483648) {
        // 16#8000 0000---1111110x 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx
...
var utf8ToChar = function utf8ToChar(a) {
    ...
    while (offset < a.length) {
        if (a.length >= offset + 1 && a[offset] < 128) {
            ...
            // 2097152:16#200000---11110xxx 10xxxxxx 10xxxxxx 10xxxxxx
            ...
            // 67108864:16#400 0000---111110xx 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx
            ...
            // 2147483648:16#8000 0000---1111110x 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx
