...
var matchBisect = function matchBisect(arr1, start1, end1, arr2, start2, end2, equal, hash, result) {
    ...
    for (var d = 0; d < max_d; d++) {
        var r1 = matchBisect1(d, k1start, k1end, v_offset, v1, v2, len1, len2, equal, arr1, start1, arr2, start2, front, delta, v_length, end1, end2, hash, result);
        k1start = r1.k1start;
        k1end = r1.k1end;
        if (r1.r !== undefined) return r1.r;
        var r2 = matchBisect2(d, k1start, k1end, v_offset, v1, v2, len1, len2, equal, arr1, start1, arr2, start2, front, delta, v_length, end1, end2, hash, result);
        k2start = r2.k2start;
        k2end = r2.k2end;
...
// 在前面的路径中走一步
var matchBisect1 = function matchBisect1(d, k1start, k1end, v_offset, v1, v2, len1, len2, equal, arr1, start1, arr2, start2, front, delta, v_length, end1, end2, hash, result) {
    ...
    return { k1start: k1start, k1end: k1end, r: r };
};
// 反向路径走一步
var matchBisect2 = function matchBisect2(d, k2start, k2end, v_offset, v1, v2, len1, len2, equal, arr1, start1, arr2, start2, front, delta, v_length, end1, end2, hash, result) {
    var k1_offset = void 0;
    var k2_offset = void 0;
    var x1 = void 0;
    var x2 = void 0;
    ...
    return { k2start: k2start, k2end: k2end, r: r };
};
/**
