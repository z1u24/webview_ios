...
var Tree = function () {
    ...
    _createClass(Tree, [{
        ...
        key: "keys",
        value: /*#__PURE__*/regeneratorRuntime.mark(function keys(key) {
            var root, cmp;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            root = this.root;
                            cmp = this.cmp;
                            return _context.delegateYield(key ? iterKey(root, cmp, key, getKey) : iter(root, getKey), "t0", 3);
        ...
        key: "values",
        value: /*#__PURE__*/regeneratorRuntime.mark(function values(key) {
            var root, cmp;
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            root = this.root;
                            cmp = this.cmp;
                            return _context2.delegateYield(key ? iterKey(root, cmp, key, getValue) : iter(root, getValue), "t0", 3);
        ...
        key: "items",
        value: /*#__PURE__*/regeneratorRuntime.mark(function items(key) {
            var root, cmp;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            root = this.root;
                            cmp = this.cmp;
                            return _context3.delegateYield(key ? iterKey(root, cmp, key, getItem) : iter(root, getItem), "t0", 3);
...
var iterKey = /*#__PURE__*/regeneratorRuntime.mark(function iterKey(node, cmp, key, get) {
    var r;
...
// 迭代指定节点
// tslint:disable-next-line:no-function-expression
var iter = /*#__PURE__*/regeneratorRuntime.mark(function iter(node, get) {
