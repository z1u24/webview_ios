...
exports.fetchCloudWalletAssetList = function () {
    ...
    var ktCny = store_1.getBorn('exchangeRateJson').get('KT').CNY;
    var ktItem = {
        currencyName: 'KT',
        description: 'KuPlay Token',
        balance: exports.formatBalance(ktBalance),
        balanceValue: exports.formatBalanceValue(ktBalance * ktCny),
...
//获取当前显示版本号
exports.getCurShowVersion = function () {
    return config_1.version.slice(0, config_1.version.length - 7);
};
//获取本地版本号
