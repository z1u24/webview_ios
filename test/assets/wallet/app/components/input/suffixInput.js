_$define("app/components/input/suffixInput", function (require, exports, module){
"use strict";
...
var SuffixInput = function (_widget_1$Widget) {
    _inherits(SuffixInput, _widget_1$Widget);

    function SuffixInput() {
        _classCallCheck(this, SuffixInput);

        return _possibleConstructorReturn(this, (SuffixInput.__proto__ || Object.getPrototypeOf(SuffixInput)).call(this));
    }

    _createClass(SuffixInput, [{
        key: "create",
        ...
        value: function setProps(props, oldProps) {
            _get(SuffixInput.prototype.__proto__ || Object.getPrototypeOf(SuffixInput.prototype), "setProps", this).call(this, props, oldProps);
            if (props.input) {
