(function (_cfg, it, it1) {
  var _$temp = void 0,
    ...
    var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 2;_node.attrHash = 2520441572;_node.attrs["on-tap"] = "doClick";_node.attrs["style"] = "display: inline-block;";var myColor = it.types ? it.activeColor || 'linear-gradient(to right,#318DE6,#38CFE7)' : it.inactiveColor || '#dcdfe6';_$temp = _node;{
      var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "span", "sid": 1 };_node2.children = [];_node2.attrSize = 3;_node2.attrHash = 3241489052;_node2.attrs["w-class"] = "switch_bg";{
        var attrvalue = "";attrvalue += it.types ? 'switch_icon_select' : 'switch_icon';attrvalue += "";_node2.attrs["class"] = attrvalue;
