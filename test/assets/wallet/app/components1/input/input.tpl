(function (_cfg, it, it1) {
  var _$temp = void 0,
    ...
    var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 2;_node.attrHash = 2983613905;_node.attrs["w-class"] = "pi-input-box";_node.attrs["class"] = "pi-input";_$temp = _node;{
      ...
      _$temp = _node;{
        var _$parent3 = _$temp;var _node3 = { "attrs": {}, "tagName": "img", "sid": 2 };_node3.children = [];_node3.childHash = 0;_node3.attrSize = 3;_node3.attrHash = 2758796760;_node3.attrs["w-class"] = "pi-input__suffix";_node3.attrs["src"] = "../../res/image/btn_img_close.png";_node3.attrs["on-tap"] = "clearClickListener";_$parent3.children.push(_node3);
      }
