	...
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 3437572703;_node.attrs["class"] = "new-page";_node.attrs["w-class"] = "new-page";_node.attrs["ev-back-click"] = "backPrePage";_$temp = _node;{
				...
				var _$parent5 = _$temp;var _node5 = { "attrs": {}, "tagName": "div", "sid": 3 };_node5.children = [];_node5.attrSize = 1;_node5.attrHash = 253915434;_node5.attrs["w-class"] = "head2";_$temp = _node5;{
					...
					var _$parent12 = _$temp;var _node10 = { "attrs": {}, "tagName": "div", "sid": 7 };_node10.children = [];_node10.attrSize = 1;_node10.attrHash = 3242123177;_node10.attrs["w-class"] = "head2-right";_$temp = _node10;{
						...
						var _$parent15 = _$temp;var _node12 = { "attrs": {}, "tagName": "span", "sid": 9 };_node12.children = [];_node12.attrSize = 2;_node12.attrHash = 2981695675;_node12.attrs["w-class"] = "btn btn-withdraw";_node12.attrs["on-tap"] = "withdrawClick";_$temp = _node12;{
							var _$parent16 = _$temp;_addText(it1.cfgData.withdraw, _$parent16);
			...
			var _$parent21 = _$temp;var _node16 = { "attrs": {}, "tagName": "div", "sid": 13 };_node16.children = [];_node16.attrSize = 1;_node16.attrHash = 915048845;_node16.attrs["w-class"] = "show-container";_$temp = _node16;{
				...
				_$temp = _node16;{
					var _$parent34 = _$temp;var _node23 = { "attrs": {}, "tagName": "div", "sid": 16 };_node23.children = [];_node23.attrSize = 1;_node23.attrHash = 2255571891;{
						var _attrvalue3 = "";_attrvalue3 += it1.gain > 0 ? 'down' : 'up';_attrvalue3 += "";_node23.attrs["w-class"] = _attrvalue3;
					}_node23.attrHash = _hash.nextHash(_node23.attrHash, _calTextHash(_node23.attrs["w-class"]));_$temp = _node23;{
						var _$parent35 = _$temp;_addText(it1.cfgData.today, _$parent35);
					}_$temp = _node23;{
						var _$parent36 = _$temp;var _node24 = _installText("&nbsp;", 1553561131);;
						_$parent36.children.push(_node24);
					}_$temp = _node23;{
						var _$parent37 = _$temp;_addText(it1.gain > 0 ? '+' : '', _$parent37);
					}_$temp = _node23;{
						var _$parent38 = _$temp;_addText(it1.gain, _$parent38);
					}_$temp = _node23;{
						var _$parent39 = _$temp;var _node25 = _installText("%", 4257547020);;
						_$parent39.children.push(_node25);
					}_chFunc(_node23);_$parent34.children.push(_node23);
				}
			}_chFunc(_node16);_$parent21.children.push(_node16);
		}_$temp = _node;{
			var _$parent40 = _$temp;var _node26 = { "attrs": {}, "tagName": "div", "sid": 17 };_node26.children = [];_node26.attrSize = 1;_node26.attrHash = 4252679546;_node26.attrs["w-class"] = "body";{
				var _$i2 = 0;
				for (var _iterator2 = it1.tabs, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
					...
					var _v = _ref2;
					var _i3 = _$i2++;var _isActive = _i3 === it1.activeNum;_$temp = _node26;{
						var _$parent41 = _$temp;var _node27 = { "attrs": {}, "tagName": "widget", "sid": 18 };_node27.hasChild = false;_node27.child = null;_node27.attrSize = 1;_node27.attrHash = 543012080;{
							var _attrvalue4 = "";_attrvalue4 = _v.components;_node27.attrs["w-tag"] = _attrvalue4;
						}_node27.attrHash = _hash.nextHash(_node27.attrHash, _calTextHash(_node27.attrs["w-tag"]));_node27.tagName = _node27.attrs["w-tag"];{
							var _attrvalue5 = "";_attrvalue5 += "visibility: ";_attrvalue5 += _isActive ? 'visible' : 'hidden';_attrvalue5 += "; z-index:";_attrvalue5 += _isActive ? 0 : -1;_attrvalue5 += ";  width:100%;height: 100%;";_node27.attrs["style"] = _attrvalue5;
						}_node27.attrHash = _hash.nextHash(_node27.attrHash, _calTextHash(_node27.attrs["style"]));_$temp = _node27;{
							var _$parent42 = _$temp;var _node28 = {}; //jpair pre

							_node28["isActive"] = _isActive;
							//jpair suf
							//jpair pre

							_node28["currencyName"] = it.currencyName;
							//jpair suf
							_addJson(_node28, _$parent42);
						}_chFunc(_node27);_$parent41.children.push(_node27);
					}
				}
			}_chFunc(_node26);_$parent40.children.push(_node26);
