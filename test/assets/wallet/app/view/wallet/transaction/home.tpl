	...
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 4;_node.attrHash = 274209324;_node.attrs["class"] = "new-page";_node.attrs["w-class"] = "new-page";_node.attrs["ev-back-click"] = "backPrePage";_node.attrs["ev-next-click"] = "chooseAddrClick";_$temp = _node;{
			...
			var _$parent25 = _$temp;var _node20 = { "attrs": {}, "tagName": "div", "sid": 17 };_node20.children = [];_node20.attrSize = 1;_node20.attrHash = 915048845;_node20.attrs["w-class"] = "show-container";_$temp = _node20;{
				...
				_$temp = _node20;{
					var _$parent38 = _$temp;var _node27 = { "attrs": {}, "tagName": "div", "sid": 20 };_node27.children = [];_node27.attrSize = 1;_node27.attrHash = 2255571891;{
						var _attrvalue2 = "";_attrvalue2 += it.gain > 0 ? 'down' : 'up';_attrvalue2 += "";_node27.attrs["w-class"] = _attrvalue2;
					}_node27.attrHash = _hash.nextHash(_node27.attrHash, _calTextHash(_node27.attrs["w-class"]));_$temp = _node27;{
						var _$parent39 = _$temp;_addText(it1.cfgData.tabs[4], _$parent39);
					}_$temp = _node27;{
						var _$parent40 = _$temp;var _node28 = _installText("&nbsp;", 1553561131);;
						_$parent40.children.push(_node28);
					}_$temp = _node27;{
						var _$parent41 = _$temp;_addText(it.gain > 0 ? '+' : '', _$parent41);
					}_$temp = _node27;{
						var _$parent42 = _$temp;_addText(it.gain, _$parent42);
					}_$temp = _node27;{
						var _$parent43 = _$temp;var _node29 = _installText("%", 4257547020);;
						_$parent43.children.push(_node29);
					}_chFunc(_node27);_$parent38.children.push(_node27);
				}
			}_chFunc(_node20);_$parent25.children.push(_node20);
		}_$temp = _node;{
			var _$parent44 = _$temp;var _node30 = { "attrs": {}, "tagName": "div", "sid": 21 };_node30.children = [];_node30.attrSize = 1;_node30.attrHash = 4252679546;_node30.attrs["w-class"] = "body";_$temp = _node30;{
				var _$parent45 = _$temp;var _node31 = { "attrs": {}, "tagName": "div", "sid": 22 };_node31.children = [];_node31.attrSize = 1;_node31.attrHash = 1331109157;_node31.attrs["w-class"] = "tx-list-container";if (it1.txList.length === 0) {
					_$temp = _node31;{
						var _$parent46 = _$temp;var _node32 = { "attrs": {}, "tagName": "div", "sid": 23 };_node32.children = [];_node32.attrSize = 1;_node32.attrHash = 1587261762;_node32.attrs["w-class"] = "no-recode";_$temp = _node32;{
							var _$parent47 = _$temp;var _node33 = { "attrs": {}, "tagName": "img", "sid": 24 };_node33.children = [];_node33.childHash = 0;_node33.attrSize = 2;_node33.attrHash = 832237403;_node33.attrs["src"] = "../../../res/image/dividend_history_none.png";_node33.attrs["w-class"] = "no-recode-icon";_$parent47.children.push(_node33);
						}_$temp = _node32;{
							var _$parent48 = _$temp;var _node34 = { "attrs": {}, "tagName": "div", "sid": 25 };_node34.children = [];_node34.attrSize = 1;_node34.attrHash = 308010609;_node34.attrs["w-class"] = "no-recode-text";_$temp = _node34;{
								var _$parent49 = _$temp;_addText(it1.cfgData.noneRes, _$parent49);
							}_chFunc(_node34);_$parent48.children.push(_node34);
						}_chFunc(_node32);_$parent46.children.push(_node32);
					}
				}_$temp = _node31;{
					var _$parent50 = _$temp;var _node35 = { "attrs": {}, "tagName": "div", "sid": 26 };_node35.children = [];_node35.attrSize = 1;_node35.attrHash = 660002203;_node35.attrs["w-class"] = "tx-list";{
						var _$i = 0;
						for (var _iterator = it1.txList, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
							...
							var v = _ref;
							var i = _$i++;_$temp = _node35;{
								var _$parent51 = _$temp;var _node36 = { "attrs": {}, "tagName": "div", "sid": 27 };_node36.children = [];_node36.attrSize = 1;_node36.attrHash = 1363181170;{
									var _attrvalue3 = "";_attrvalue3 += "txListItemClick(e,";_attrvalue3 += i;_attrvalue3 += ")";_node36.attrs["on-tap"] = _attrvalue3;
								}_node36.attrHash = _hash.nextHash(_node36.attrHash, _calTextHash(_node36.attrs["on-tap"]));_$temp = _node36;{
									var _$parent52 = _$temp;var _node37 = { "attrs": {}, "tagName": "app-components-fourParaImgItem-fourParaImgItem", "sid": 28 };_node37.hasChild = false;_node37.child = null;_node37.attrHash = 0;_$temp = _node37;{
										var _$parent53 = _$temp;var _node38 = {}; //jpair pre

										_node38["name"] = v.txTypeShow;
										//jpair suf
										//jpair pre
										...
										_node38["time"] = v.TimeShow;
										//jpair suf
										//jpair pre

										_node38["describe"] = v.statusShow;
										//jpair suf
										//jpair pre

										{
											...
											_node38["img"] = _jvalue2;
										}
										_addJson(_node38, _$parent53);
									}_chFunc(_node37);_$parent52.children.push(_node37);
								}_chFunc(_node36);_$parent51.children.push(_node36);
							}
						}
					}_chFunc(_node35);_$parent50.children.push(_node35);
				}_chFunc(_node31);_$parent45.children.push(_node31);
			}_chFunc(_node30);_$parent44.children.push(_node30);
