	...
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 1;_node.attrHash = 1045235690;_node.attrs["w-class"] = "item";_$temp = _node;{
			var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "div", "sid": 1 };_node2.children = [];_node2.attrSize = 1;_node2.attrHash = 863200548;_node2.attrs["w-class"] = "inner1";_$temp = _node2;{
				...
				var _$parent8 = _$temp;var _node7 = { "attrs": {}, "tagName": "div", "sid": 5 };_node7.children = [];_node7.attrSize = 1;_node7.attrHash = 3568076218;_node7.attrs["w-class"] = "desc";_$temp = _node7;{
					var _$parent9 = _$temp;_addText(it1.cfgData.title, _$parent9);
				}_chFunc(_node7);_$parent8.children.push(_node7);
			}_chFunc(_node2);_$parent2.children.push(_node2);
		}_$temp = _node;{
			var _$parent10 = _$temp;var _node8 = { "attrs": {}, "tagName": "div", "sid": 6 };_node8.children = [];_node8.attrSize = 1;_node8.attrHash = 4169587451;_node8.attrs["w-class"] = "inner2";_$temp = _node8;{
				var _$parent11 = _$temp;var _node9 = { "attrs": {}, "tagName": "div", "sid": 7 };_node9.children = [];_node9.attrSize = 1;_node9.attrHash = 1540292426;_node9.attrs["w-class"] = "name";_$temp = _node9;{
					var _$parent12 = _$temp;_addText(it.product.productName, _$parent12);
				}_chFunc(_node9);_$parent11.children.push(_node9);
			}_$temp = _node8;{
				var _$parent13 = _$temp;var _node10 = { "attrs": {}, "tagName": "div", "sid": 8 };_node10.children = [];_node10.attrSize = 1;_node10.attrHash = 3568076218;_node10.attrs["w-class"] = "desc";_$temp = _node10;{
			...
			var _$parent15 = _$temp;var _node11 = { "attrs": {}, "tagName": "app-components-ringProgressBar-ringProgressBar", "sid": 9 };_node11.hasChild = false;_node11.child = null;_node11.attrHash = 0;_$temp = _node11;{
				var _$parent16 = _$temp;var _node12 = {}; //jpair pre

				_node12["width"] = 80;
				//jpair suf
				//jpair pre

				_node12["borderWidth"] = 4;
				//jpair suf
				//jpair pre

				{
					...
					_node12["activeColor"] = jvalue;
				}
				//jpair pre

				_node12["activePercent"] = 1 - it.product.surplus / it.product.total;
				//jpair suf
				//jpair pre

				{
					...
					_node12["centerStyle"] = _jvalue;
				}
				//jpair pre

				_node12["centerText"] = it.product.surplus === 0 ? it1.cfgData.saleOut : Math.floor(it.product.surplus / it.product.total * 100) + '%';
				//jpair suf
				_addJson(_node12, _$parent16);
