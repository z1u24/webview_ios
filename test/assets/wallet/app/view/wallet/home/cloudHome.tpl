(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 1;_node.attrHash = 3118159832;_node.attrs["w-class"] = "asset-container";_$temp = _node;{
			...
			var _$parent7 = _$temp;var _node5 = { "attrs": {}, "tagName": "div", "sid": 3 };_node5.children = [];_node5.attrSize = 1;_node5.attrHash = 2812074640;_node5.attrs["w-class"] = "container";_$temp = _node5;{
				...
				var _$parent11 = _$temp;var _node9 = { "attrs": {}, "tagName": "div", "sid": 6 };_node9.children = [];_node9.attrSize = 1;_node9.attrHash = 1511636449;_node9.attrs["w-class"] = "fm-container";_$temp = _node9;{
					var _$parent12 = _$temp;var _node10 = { "attrs": {}, "tagName": "div", "sid": 7 };_node10.children = [];_node10.attrSize = 1;_node10.attrHash = 2314726494;_node10.attrs["w-class"] = "fm-title";_$temp = _node10;{
						var _$parent13 = _$temp;var _node11 = { "attrs": {}, "tagName": "div", "sid": 8 };_node11.children = [];_node11.attrHash = 0;_$temp = _node11;{
							var _$parent14 = _$temp;_addText(it1.cfgData.financial, _$parent14);
						}_chFunc(_node11);_$parent13.children.push(_node11);
					}_$temp = _node10;{
						var _$parent15 = _$temp;var _node12 = { "attrs": {}, "tagName": "img", "sid": 9 };_node12.children = [];_node12.childHash = 0;_node12.attrSize = 3;_node12.attrHash = 1166230486;_node12.attrs["src"] = "../../../res/image/right_arrow_gray.png";_node12.attrs["on-tap"] = "optimalClick";_node12.attrs["w-class"] = "fmImg";_$parent15.children.push(_node12);
					}_chFunc(_node10);_$parent12.children.push(_node10);
				}_$temp = _node9;{
					var _$parent16 = _$temp;var _node13 = { "attrs": {}, "tagName": "div", "sid": 10 };_node13.children = [];_node13.attrSize = 1;_node13.attrHash = 1491037490;_node13.attrs["w-class"] = "fm-list";{
						var _$i = 0;
						for (var _iterator = it1.productList, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
							...
							var i = _$i++;_$temp = _node13;{
								var _$parent17 = _$temp;var _node14 = { "attrs": {}, "tagName": "div", "sid": 11 };_node14.children = [];_node14.attrSize = 1;_node14.attrHash = 3277888839;{
									var attrvalue = "";attrvalue += "fmItemClick(e,";attrvalue += i;attrvalue += ")";_node14.attrs["on-tap"] = attrvalue;
								}_node14.attrHash = _hash.nextHash(_node14.attrHash, _calTextHash(_node14.attrs["on-tap"]));_$temp = _node14;{
									var _$parent18 = _$temp;var _node15 = { "attrs": {}, "tagName": "app-view-wallet-components-fmListItem", "sid": 12 };_node15.hasChild = false;_node15.child = null;_node15.attrHash = 0;_$temp = _node15;{
										var _$parent19 = _$temp;var _node16 = {}; //jpair pre

										_node16["product"] = v;
										//jpair suf
										_addJson(_node16, _$parent19);
