	...
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 2;_node.attrHash = 2139844790;_node.attrs["class"] = "new-page";_node.attrs["ev-back-click"] = "backPrePage";_$temp = _node;{
			...
			var _$parent4 = _$temp;var _node4 = { "attrs": {}, "tagName": "div", "sid": 2 };_node4.children = [];_node4.attrSize = 1;_node4.attrHash = 487306359;_node4.attrs["w-class"] = "content";_$temp = _node4;{
				...
				var _$parent7 = _$temp;var _node7 = { "attrs": {}, "tagName": "div", "sid": 5 };_node7.children = [];_node7.childHash = 2846474447;_node7.attrSize = 1;_node7.attrHash = 866865791;_node7.attrs["w-class"] = "version";_$temp = _node7;{
					var _$parent8 = _$temp;var _node8 = _installText("V0.0.1", 143603994);;
					_$parent8.children.push(_node8);
				}_$parent7.children.push(_node7);
			}_$temp = _node4;{
				var _$parent9 = _$temp;var _node9 = { "attrs": {}, "tagName": "div", "sid": 6 };_node9.children = [];_node9.attrSize = 1;_node9.attrHash = 2002705810;_node9.attrs["w-class"] = "shortmess";_$temp = _node9;{
					var _$parent10 = _$temp;_addText(it1.cfgData.shortMess, _$parent10);
				...
				for (var _iterator = it1.data, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
					...
					var ind = _$i++;_$temp = _node4;{
						var _$parent11 = _$temp;var _node10 = { "attrs": {}, "tagName": "div", "sid": 7 };_node10.children = [];_node10.attrSize = 1;_node10.attrHash = 1810915363;{
							...
							var _$parent12 = _$temp;var _node11 = { "attrs": {}, "tagName": "app-components-basicItem-basicItem", "sid": 8 };_node11.hasChild = false;_node11.child = null;_node11.attrHash = 0;_$temp = _node11;{
