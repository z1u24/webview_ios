    ...
    _createClass(ContanctUs, [{
        ...
        value: function create() {
            ...
            this.state = {
                ...
                data: [{ value: cfg.itemTitle[0], desc: 'www.Kuplay.io' }, { value: cfg.itemTitle[1], desc: cfg.itemTitle[2] }, { value: cfg.itemTitle[3], desc: 'KuPlay' }],
                cfgData: cfg
            };
        }
    }, {
        ...
        value: function itemClick(e, ind) {
            switch (ind) {
                ...
                case 0:
                    ...
                    native_1.openNewActivity('http://www.KuPay.io', 'KuPay');
                    break;
                // KuPay小助手
                case 1:
