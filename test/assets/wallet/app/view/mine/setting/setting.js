    ...
    _createClass(Setting, [{
        ...
        value: function init() {
            ...
            this.state = {
                ...
                itemList: [{ title: cfg.itemTitle[3], list: cfg.languageSet, selected: lan ? lan.selected : 0 }, { title: cfg.itemTitle[4], list: ['CNY', 'USD'], selected: 0 }, { title: cfg.itemTitle[5], list: cfg.changeColor, selected: color ? color.selected : 0 }],
        ...
        value: function initData() {
            ...
            var bphone = store_1.find('verPhone');
            if (bphone) {
        ...
        value: function itemClick(ind) {
            ...
            if (ind === 0) {
                ...
                root_1.popNew('app-view-mine-setting-itemList', data, function (index) {
                    _this6.state.itemList[ind - 2].selected = index;
                    if (ind === 2) {
                        // tslint:disable-next-line:max-line-length
        ...
        value: function logOut() {
            ...
            root_1.popNew('app-components-modalBox-modalBox', this.state.cfgData.modalBox2, function () {
                ...
                root_1.popNew('app-components-modalBox-modalBox', { title: '', content: _this7.state.cfgData.tips[2], style: 'color:#F7931A;' }, function () {
...
store_1.register('verPhone', function () {
    var w = exports.forelet.getWidget(exports.WIDGET_NAME);
    if (w) {
        w.initData();
    }
