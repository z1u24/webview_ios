...
var WebViewManager = function (_native_1$NativeObjec) {
    ...
    _createClass(WebViewManager, null, [{
        ...
        key: "getScreenModify",
        value: function getScreenModify(success) {
            webViewMgr.call('getScreenModify', { success: success });
        }
        /**
        ...
        key: "newView",
        value: function newView(webViewName, url, headers) {
            headers = headers || {};
            var headerString = JSON.stringify(headers);
            webViewMgr.call('newView', { webViewName: webViewName, url: url, headers: headerString });
        }
        /**
        ...
        key: "freeView",
        value: function freeView(webViewName) {
            webViewMgr.call('freeView', { webViewName: webViewName });
        }
        /**
         * 往指定名字的WebView发信息
         */
        ...
        value: function endTimer() {
            webViewMgr.call('endTimerInWebView', {});
        }
    }]);
