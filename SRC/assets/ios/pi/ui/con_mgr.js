 ...
 * 打开连接
 */
exports.open = function (callback, errorCallback, timeout) {
 ...
 * 通讯请求
 */
exports.request = function (msg, cb, timeout, force) {
...
exports.login = function (uid, type, password, cb, timeout) {
    if (con === null) {
    ...
    con.request({ type: 'login', param: { type: type, password: password, user: uid } }, function (result) {
        if (result.error) {
 ...
 * 消息处理器
 */
exports.setMsgHandler = function (type, cb) {
    handlerMap.add(type, function (r) {
