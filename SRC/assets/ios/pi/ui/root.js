 ...
 * @example
 */
exports.pop = function (w, ok, cancel, process, back, originProps) {
    ...
    var r = void 0;
    var propsSensitive = false;
    for (var i = 0; i < exports.routerList.length; i++) {
        var props = exports.routerList[i].props;
...
exports.popNew = function (name, props, ok, cancel, process, back) {
    ...
    var close = exports.pop(w, ok, cancel, process, back, props);
...
// 序列化routerList
var routerListSerialize = function routerListSerialize() {
