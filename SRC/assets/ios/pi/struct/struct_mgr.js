...
var MStructMeta = function (_StructMeta) {
    ...
    _createClass(MStructMeta, [{
        ...
        value: function delStruct(ss) {
            ...
            if (!s) throw new Error("StructMeta Error:struct is not exist!,index:" + ss._$index);
...
var Bon = function (_Struct) {
    _inherits(Bon, _Struct);

    function Bon(data) {
        _classCallCheck(this, Bon);

        var _this2 = _possibleConstructorReturn(this, (Bon.__proto__ || Object.getPrototypeOf(Bon)).call(this));
...
var MStruct = function (_Struct2) {
    _inherits(MStruct, _Struct2);
    ...
    _createClass(MStruct, [{
        key: "insertMeta",
        value: function insertMeta(mgr, index) {}
    }]);
...
exports.addToMeta = function (ss, struct) {
    ...
    if (!meta) throw new Error("unregister struct, name:" + struct.constructor.name);
...
var StructMgr = function () {
    ...
    _createClass(StructMgr, [{
        ...
        value: function register(nameHash, construct, name) {
            var hash = construct._$info.name_hash;
            var meta = this.numberMap.get(hash);
            if (meta) throw new Error("class already register, name:" + name);
            var s = void 0;
