 ...
 */
exports.requestAsyncNeedLogin = function (msg, secretHash) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.t0 = memstore_1.getStore('setting/deviceId');
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.t0 = memstore_1.getStore('setting/deviceId');
...
exports.openConnect = function () {
    var secrectHash = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        ...
                        con_mgr_1.open(conSuccess(secrectHash), conError, conClose, conReOpen);
 ...
 * 连接成功回调
 */
var conSuccess = function conSuccess(secrectHash) {
    return function () {
        console.log('con success');
        memstore_1.setStore('user/offline', false);
        exports.getRandom(secrectHash);
    };
};
/**
 * 连接出错回调
 ...
 */
exports.getRandom = function (secretHash, cmd) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        var wallet, deviceInfo, client, param, msg, resp, conRandom, flags;
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
            while (1) {
                switch (_context6.prev = _context6.next) {
                    ...
                    case 4:
                        deviceInfo = memstore_1.getStore('setting/deviceInfo') || {};
                        client = deviceInfo.system || navigator.userAgent;
                        param = {
                    ...
                    case 21:
                        ...
                        if (_context6.t0.type === 1014) {
                            flags = memstore_1.getStore('flags');

                            console.log('flags =====', flags);
                            if (flags.level_2_page_loaded) {
                                // 钱包创建成功直接提示,此时资源已经加载完成
                                tools_1.kickOffline(secretHash); // 踢人下线提示
                            } else {
                                // 刷新页面后，此时资源没有加载完成,延迟到资源加载成功弹出提示
...
exports.getServerCloudBalance = function () {
    ...
    list.push(interface_1.CloudCurrencyType.ST);
                ...
                switch (_context10.prev = _context10.next) {
                    case 0:
                        ...
                        exports.requestAsync(msg).then(function (data) {
                            ...
                            var nowNum = Math.round((totalNum - holdNum + today) * 0.25) - today; // 今日可挖数量为矿山剩余量的0.25减去今日已挖 再四舍五入取整
                            if (nowNum <= 0) {
 ...
 */
// tslint:disable-next-line:max-line-length
exports.sendRedEnvlope = function (rtype, ctype, totalAmount, redEnvelopeNumber, lm, secretHash) {
            ...
            while (1) {
                switch (_context15.prev = _context15.next) {
                    case 0:
                        ...
                        _context15.prev = 1;
                        _context15.next = 4;
                        return exports.requestAsyncNeedLogin(msg, secretHash);
 ...
 * 获取单个用户信息
 */
exports.getOneUserInfo = function (uids, isOpenid) {
            ...
            while (1) {
                switch (_context28.prev = _context28.next) {
                    case 0:
                        ...
                        if (isOpenid) {
                            msg = { type: 'wallet/user@get_infos', param: { list: "[" + uids.toString() + "]", isOpenid: isOpenid } };
                        } else {
                            msg = { type: 'wallet/user@get_infos', param: { list: "[" + uids.toString() + "]" } };
                        }
                        _context28.prev = 2;
 ...
 * 批量获取用户信息
 */
exports.getUserList = function (uids, isOpenid) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee29() {
        var msg, res, resAry, _iterator2, _isArray2, _i2, _ref4, element;
            ...
            while (1) {
                switch (_context29.prev = _context29.next) {
                    ...
                    case 5:
                        ...
                        resAry = [];
                        _iterator2 = res.value, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();
                    ...
                    case 19:
                        ...
                        resAry.push(JSON.parse(tools_1.unicodeArray2Str(element)));
                    ...
                    case 23:
                        return _context29.abrupt("return", resAry);
                    ...
                    case 26:
                        ...
                        toolMessages_1.showError(_context29.t0 && (_context29.t0.result || _context29.t0.type));
...
exports.getAccountDetail = function (coin, filter) {
    ...
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee31() {
        var msg, res, nextStart, detail, splitDetail, canLoadMore, cloudWallets, cloudWallet, _cloudWallet$otherLog, _cloudWallet$recharge, _cloudWallet$withdraw;
            ...
            while (1) {
                switch (_context31.prev = _context31.next) {
                    ...
                    case 5:
                        ...
                        splitDetail = parse_1.splitGtAccountDetail(detail);
                        ...
                        if (detail.length > 0) {
                            ...
                            if (filter === 1) {
                                if (start) {
                                    ...
                                    if (coin === 'ST') {
                                        (_cloudWallet$recharge = cloudWallet.rechargeLogs.list).push.apply(_cloudWallet$recharge, _toConsumableArray(splitDetail.rechangeList));
                                        (_cloudWallet$withdraw = cloudWallet.withdrawLogs.list).push.apply(_cloudWallet$withdraw, _toConsumableArray(splitDetail.withdrawList));
                                    }
                                } else {
 ...
 * 提现
 */
exports.withdrawFromServer = function (toAddr, value, secretHash) {
 ...
 * btc提现
 */
exports.btcWithdrawFromServer = function (toAddr, value, secretHash) {
...
exports.getRechargeLogs = function (coin, start) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee44() {
        var type, msg, res, nextStart, detail, canLoadMore, cloudWallets, cloudWallet, _cloudWallet$recharge2;
                ...
                switch (_context44.prev = _context44.next) {
                    ...
                    case 15:
                        ...
                        if (detail.length > 0) {
                            ...
                            if (start) {
                                (_cloudWallet$recharge2 = cloudWallet.rechargeLogs.list).push.apply(_cloudWallet$recharge2, _toConsumableArray(detail));
                            } else {
...
exports.getWithdrawLogs = function (coin, start) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee45() {
        var type, msg, res, nextStart, detail, canLoadMore, cloudWallets, cloudWallet, _cloudWallet$withdraw2;
                ...
                switch (_context45.prev = _context45.next) {
                    ...
                    case 15:
                        ...
                        if (detail.length > 0) {
                            ...
                            if (start) {
                                (_cloudWallet$withdraw2 = cloudWallet.withdrawLogs.list).push.apply(_cloudWallet$withdraw2, _toConsumableArray(detail));
                            } else {
 ...
 * 购买理财
 */
exports.buyProduct = function (pid, count, secretHash) {
 ...
 * 赎回理财产品
 */
exports.buyBack = function (timeStamp, secretHash) {
 ...
 * 获取GT价格
 */
exports.getGoldPrice = function () {
    var ispay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
        ...
        return regeneratorRuntime.wrap(function _callee52$(_context52) {
            while (1) {
                switch (_context52.prev = _context52.next) {
                    case 0:
                        msg = { type: 'get_goldprice', param: { ispay: ispay } };
                        _context52.prev = 1;
                        _context52.next = 4;
                        return exports.requestAsync(msg);
                    ...
                    case 4:
                        ...
                        if (resData.result === 1) {
                            memstore_1.setStore('third/goldPrice', { price: resData.price, change: resData.change });
                        }
                        _context52.next = 10;
                        break;
 ...
 * 上次文件
 */
exports.uploadFile1 = function (file) {
