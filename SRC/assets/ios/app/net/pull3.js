            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        realUrl = config_1.thirdUrlPre + "?key=" + key + "&url=" + xorEncodeUrl + "&timestamp=" + timestamp + "&$forceServer=1";
...
exports.fetchUSD2CNYRate = function () {
    ...
    date.setMinutes(0);
    date.setSeconds(0);
    var timestamp = parseInt((date.getTime() / 1000).toString(), 10);
    var url = 'https://v3.exchangerate-api.com/bulk/b2c2d7f4732bd71f63730357/USD';
    return exports.getThirdFromServer(url, timestamp).then(function (res) {
