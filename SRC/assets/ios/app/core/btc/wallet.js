    ...
    _createClass(BTCWallet, [{
        ...
        value: function buildRawTransaction(output, minerFee) {
            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var collected, accumlated, i, keySet, _i, bitcore, rawTx, serialized;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 16:
                                ...
                                bitcore = Bitcore();
                                rawTx = new bitcore.Transaction().feePerKb(minerFee).from(collected).to(output.toAddr, output.amount).change(output.chgAddr === undefined ? this.derive(0) : output.chgAddr).enableRBF().sign(keySet);
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 2:
                                ...
                                output.amount = Bitcore().Unit.fromBTC(output.amount).toSatoshis();
                                bitcore = Bitcore();
                                rawTx = new bitcore.Transaction().feePerKb(minerFee).from(utxos).to(output.toAddr, output.amount).change(output.chgAddr === undefined ? this.derive(0) : output.chgAddr).enableRBF().sign([this.privateKeyOf(this.usedAdresses[address.trim()])]);
        ...
        value: function resendTx(originTxid, minerFee) {
            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
                var txInfo, vin, vout, utxos, fromAddr, bitcore, i, id, _vout, address, satoshis, addr, script, scriptPubkey, utxo, tx, _i6, value, _address, keySet, _i7;
                        ...
                        switch (_context5.prev = _context5.next) {
                            ...
                            case 12:
                                ...
                                for (i = 0; i < vin.length; i++) {
                                    ...
                                    addr = Bitcore().Address.fromString(address);
                                    script = Bitcore().Script.buildPublicKeyHashOut(addr);
                                ...
                                for (_i6 = 0; _i6 < vout.length; _i6++) {
                                    if (vout[_i6].scriptPubKey.addresses[0] !== fromAddr) {
                                        value = Bitcore().Unit.fromBTC(vout[_i6].value).toSatoshis();
        ...
        value: function privateKeyOf(index) {
            ...
            var path = void 0;
            var bitcore = Bitcore();
            var parent = new bitcore.HDPrivateKey(this.rootXpriv);
        ...
        value: function generate(strength, network, lang, passphrase) {
            ...
            var hdpriv = Bitcore().HDPrivateKey.fromSeed(seed, network);
