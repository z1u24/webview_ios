...
var DataCenter = function () {
    ...
    _createClass(DataCenter, [{
        ...
        key: "checkAddr",
        value: function checkAddr(secretHash) {
        ...
        value: function updateBalance(addr, currencyName) {
            ...
            if (config_1.ERC20Tokens[currencyName]) {
                ...
                return api.ethCall(config_1.ERC20Tokens[currencyName].contractAddr, balanceOfCode).then(function (r) {
                    var num = tools_1.formatBalance(unitTools_1.ethTokenDivideDecimals(Number(r), currencyName));
        ...
        key: "timerCheckAddr",
        value: function timerCheckAddr(needCheckAddr, secretHash) {
            var _this8 = this;
            ...
            this.checkAddrTimer = setTimeout(function () {
                _this8.timerCheckAddr(needCheckAddr, secretHash);
            }, 1000);
        }
        /**
         * 解析交易详情
        ...
        value: function parseBtcTransactionTxRecord(addr, tx) {
            ...
            var record = Object.assign({}, localTx, { hash: tx.txid, addr: addr, txType: addr === fromAddr ? localTx ? localTx.txType : interface_1.TxType.Transfer : interface_1.TxType.Receipt, fromAddr: fromAddr,
                toAddr: toAddr,
                pay: pay, time: tx.time * 1000, status: status, confirmedBlockNumber: tx.confirmations, needConfirmedBlockNumber: needConfirmedBlockNumber, info: '无', currencyName: 'BTC', fee: tools_1.formatBalance(tx.fees), nonce: -1 });
            tools_1.updateLocalTx(record);
        }
        /**
         * 通过hash清楚定时器
        ...
        key: "checkEthAddr",
        value: function checkEthAddr(secretHash) {
                ...
                return regeneratorRuntime.wrap(function _callee10$(_context10) {
                    while (1) {
                        switch (_context10.prev = _context10.next) {
                            ...
                            case 3:
                                mnemonic = walletTools_1.getMnemonicByHash(secretHash);
        ...
        key: "checkBtcAddr",
        value: function checkBtcAddr(secretHash) {
        ...
        value: function checkEthERC20TokenAddr(currencyName, secretHash) {
        ...
        key: "updateGoldPrice",
        value: function updateGoldPrice() {
            var _this14 = this;
        ...
        value: function updateCurrency2USDTRate() {
            ...
            setTimeout(function () {
                _this15.updateCurrency2USDTRate();
            }, delay);
        }
    }]);
