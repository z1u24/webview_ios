...
exports.createWalletByImage = function (option) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var secrectHashPromise, imgArgon2HashPromise, _ref, _ref2, secrectHash, vault, gwlt, wallet, user;

        return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        secrectHashPromise = tools_1.calcHashValuePromise(option.psw, memstore_1.getStore('user/salt'));
                        imgArgon2HashPromise = memstore_1.getStore('flags').imgArgon2HashPromise;

                        console.time('pi_create Promise all need');
                        _context3.next = 5;
                        return Promise.all([secrectHashPromise, imgArgon2HashPromise]);
 ...
 * @param ahash ahash
 */
exports.ahashToArgon2Hash = function (ahash, imagePsw) {
 ...
 * 计算图片Argon2 Hash
 */
exports.calcImgArgon2Hash = function (imageBase64, imagePsw) {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        _context5.next = 2;
                        return getImageAhash(imageBase64);

                    case 2:
                        ahash = _context5.sent;
                        return _context5.abrupt("return", exports.ahashToArgon2Hash(ahash, imagePsw));
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    ...
                    case 2:
                        ...
                        memstore_1.setStore('wallet', wallet, false);
                        memstore_1.setStore('user', user);
                        return _context6.abrupt("return", secrectHash);
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) {
                switch (_context7.prev = _context7.next) {
                    ...
                    case 6:
                        secretHash = _context7.sent;
                        return _context7.abrupt("return", secretHash);
