...
var DividendItem = function (_widget_1$Widget) {
    ...
    _createClass(DividendItem, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { data: this.props.data, userImg: userInfo.avatar || '../res/image/default_avater_big.png', totalNum: this.props.totalNum, more: false });
        }
    }]);
