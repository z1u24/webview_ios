...
var ExchangeDetail = function (_widget_1$Widget) {
    ...
    _createClass(ExchangeDetail, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { message: this.props.message ? this.props.message : this.language.defaultMess, redBagList: [
                    // { cuid:111,amount:1,timeShow:'04-30 14:32:00' },
                    // { cuid:111,amount:1,timeShow:'04-30 14:32:00' },
                    // { cuid:111,amount:1,timeShow:'04-30 14:32:00' }                    
                ], scroll: false, showPin: this.props.rtype === 1, userName: '', userHead: '../res/image/default_avater_big.png', curNum: 0, totalNum: 0, totalAmount: 0, greatUser: -1, greatAmount: 0 });
            this.initData();
        }
    }, {
        key: "backPrePage",
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                ...
                                _context.next = 12;
                                return pull_1.getOneUserInfo([this.props.suid]);
                            ...
                            case 15:
                                ...
                                this.props.userHead = user.avatar ? "" + config_1.uploadFileUrlPrefix + user.avatar : '../res/image/default_avater_big.png';
                                redBagList = value[0];
                                i = 0;
                            ...
                            case 19:
                                ...
                                _context.next = 22;
                                return pull_1.getOneUserInfo([redBagList[i].cuid]);

                            case 22:
                                _user = _context.sent;

                                this.props.redBagList[i].userName = _user.nickName ? _user.nickName : this.language.defaultUserName;
                                // tslint:disable-next-line:max-line-length
                                this.props.redBagList[i].avatar = _user.avatar ? "" + config_1.uploadFileUrlPrefix + _user.avatar : 'res/image/default_avater_big.png';
