...
var RedEnvHistory = function (_widget_1$Widget) {
    ...
    _createClass(RedEnvHistory, [{
                            ...
                            case 2:
                                ...
                                if (sHisRec) {
                                    ...
                                    if (hList && hList.length > this.props.recordList.length) {
                                        ...
                                        pull_1.querySendRedEnvelopeRecord(this.props.start);
                                    }
                                } else {
                                    console.log('load more from server');
                                    pull_1.querySendRedEnvelopeRecord(this.props.start);
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 3:
                                ...
                                this.props.showMoreTips = this.props.sendNumber >= constants_1.PAGELIMIT;
                                this.initRedEn();
                ...
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                for (i in this.props.recordList) {
        ...
        value: function goDetail(ind) {
            root_1.popNew('app-view-earn-redEnvelope-redEnvDetail', this.props.recordList[ind]);
        }
        /**
         * 刷新页面
         */
