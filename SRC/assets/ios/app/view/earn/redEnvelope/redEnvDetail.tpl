(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 3286765528;_node.attrs["class"] = "new-page";_node.attrs["ev-back-click"] = "backPrePage";_node.attrs["w-class"] = "new-page";topBarTitle = { "zh_Hans": "红包详情", "zh_Hant": "紅包詳情", "en": "" };if (!it.scroll) {
			_$temp = _node;{
					...
					for (var _iterator = it.redBagList, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
						...
						var ind = _$i++;userName = { "zh_Hans": val.userName, "zh_Hant": val.userName, "en": "" };greatUser = { "zh_Hans": "手气最佳", "zh_Hant": "手氣最佳", "en": "" };_$temp = _node15;{
							var _$parent25 = _$temp;var _node21 = { "attrs": {}, "tagName": "app-components-fourParaImgItem-fourParaImgItem", "sid": 15 };_node21.hasChild = false;_node21.child = null;_node21.attrHash = 0;_$temp = _node21;{
								...
								_node22["describe"] = it.greatUser == ind ? greatUser : "";
								//jpair suf
