...
var RedEnvDetail = function (_widget_1$Widget) {
    ...
    _createClass(RedEnvDetail, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { message: this.language.message, redBagList: [
                    // { cuid:111,amount:1,timeShow:'04-30 14:32:00' },
                    // { cuid:111,amount:1,timeShow:'04-30 14:32:00' },
                    // { cuid:111,amount:1,timeShow:'04-30 14:32:00' } 
                ], scroll: false, showPin: this.props.rtype === 1, userName: this.language.defaultUserName, userHead: 'res/image/default_avater_big.png', greatAmount: 0, greatUser: -1 });
            this.initData();
        }
    }, {
        key: "initData",
