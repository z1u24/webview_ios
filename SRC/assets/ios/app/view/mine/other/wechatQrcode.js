...
var WechatQrcode = function (_widget_1$Widget) {
    ...
    _createClass(WechatQrcode, [{
        ...
        value: function setProps(props) {
            _get(WechatQrcode.prototype.__proto__ || Object.getPrototypeOf(WechatQrcode.prototype), "setProps", this).call(this, props);
            this.initData();
        }
    }, {
        key: "initData",
        value: function initData() {
            ...
            this.props = Object.assign({}, this.props, { walletName: modulConfig_1.getModulConfig('WALLET_NAME'), wachatHelperQrcode: modulConfig_1.getModulConfig('WECHAT_HELPER'), wachatQrcode: modulConfig_1.getModulConfig('WECHAT_ACCOUNT') });
        }
    }, {
        key: "backPrePage",
