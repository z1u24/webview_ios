    ...
    _createClass(Home, [{
        ...
        value: function initData() {
            ...
            if (wallet) {
                ...
                this.props.address = memstore_1.getStore('user/id');
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 7:
                                ...
                                if (ret) {
                                    root_1.popNew('app-view-wallet-backup-index', Object.assign({}, ret, { pi_norouter: true }));
                                    // this.backPrePage();
                                }
        ...
        value: function itemClick(ind) {
            if (ind === 0) {
                ...
                native_1.openNewActivity('https://github.com/KuPayIo/kupay_wallet', this.props.walletName);
            } else {
                root_1.popNew(this.props.list[ind].components);
            }
            // this.backPrePage();
        }
        /**
        ...
        value: function copyAddr() {
            tools_1.copyToClipboard(this.props.address);
        ...
        key: "showMyMedal",
        value: function showMyMedal() {
            root_1.popNew('earn-client-app-view-medal-medal');
            // this.backPrePage();
        }
        /**
         * 创建钱包
