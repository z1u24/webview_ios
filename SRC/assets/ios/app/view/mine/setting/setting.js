...
var Setting = function (_widget_1$Widget) {
    ...
    _createClass(Setting, [{
        ...
        value: function onSwitchChange() {
            ...
            if (this.props.openLockScreen) {
                ...
                root_1.popNew('app-components1-lockScreenPage-lockScreenPage', { setting: true }, function (r) {
                    if (!r) {
                        _this2.closeLockPsw();
                        _this2.props.openLockScreen = false;
                    } else {
                        _this2.props.openLockScreen = true;
                    }
                });
            } else {
        ...
        value: function itemClick(ind) {
            // if (!hasWallet()) return;
            var data = this.props.itemList[ind];
        ...
        value: function logOut() {
            ...
            var backup = this.props.wallet.isBackup;
