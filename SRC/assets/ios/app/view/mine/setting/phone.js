    ...
    _createClass(BindPhone, [{
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                _context.next = 7;
                                return pull_1.regPhone(this.props.phone, this.props.code.join(''));
        ...
        value: function setCode() {
            for (var i in [1, 2, 3, 4]) {
                ...
                document.getElementById('codeInput' + i).value = this.props.code[i];
            }
        }
        /**
         * 验证码改变
        ...
        value: function codeChange(e) {
            ...
            if (e.key === 'Backspace') {
                this.props.code.pop();
                var ind = this.props.code.length;
                if (ind >= 0) {
                    // tslint:disable-next-line:prefer-template
                ...
                var _ind = this.props.code.length;
                // tslint:disable-next-line:prefer-template
