...
var ExportPrivateKey = function (_widget_1$Widget) {
    ...
    _createClass(ExportPrivateKey, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { collapseList: collapseList });
        }
    }, {
        key: "backPrePage",
        ...
        value: function collapseItemClick(e) {
            var privateKey = this.props.collapseList[e.collapseListIndex].textList[e.textListIndex].privateKey;
