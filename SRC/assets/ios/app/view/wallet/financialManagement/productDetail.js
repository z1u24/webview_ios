...
var ProductDetail = function (_widget_1$Widget) {
    ...
    _createClass(ProductDetail, [{
        ...
        value: function init() {
            ...
            // console.log(res);
            this.props = Object.assign({}, this.props, { holdedAmout: 0, amount: 1, leftPercent: res.left, usePercent: res.use, scrollHeight: 0 });
        ...
        value: function updatePurchaseRecord(purchaseRecord) {
            this.props.holdedAmout = tools_1.fetchHoldedProductAmount(this.props.product.id);
        }
        // 页面滚动
        ...
        value: function purchaseClicked() {
            ...
            root_1.popNew('app-view-wallet-financialManagement-productStatement', { product: this.props.product, amount: this.props.amount });
        }
        /**
         * 点击阅读声明
         */
