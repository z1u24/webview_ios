...
var ProductDetail = function (_widget_1$Widget) {
    ...
    _createClass(ProductDetail, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { spend: spend,
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 12:
                                if (!(this.props.cloudBalance + this.props.localBalance >= this.props.spend)) {
                                    _context.next = 22;
                                    break;
                                }

                                fromAddr = tools_1.getCurrentAddrByCurrencyName('ETH');
                                pay = this.props.spend - this.props.cloudBalance;
                                tx = {
                                    hash: '',
