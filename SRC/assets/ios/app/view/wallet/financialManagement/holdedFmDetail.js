...
var HoldedFmDetail = function (_widget_1$Widget) {
    ...
    _createClass(HoldedFmDetail, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { stateShow: stateShow, scrollHeight: 0, stateBg: stateBg,
                btnText: btnText,
        ...
        value: function redemptionClick() {
            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var psw, close, secretHash, result;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 15:
                                _context.next = 17;
                                return pull_1.buyBack(this.props.product.purchaseTimeStamp, secretHash);
