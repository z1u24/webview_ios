    ...
    _createClass(Home, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { tabs: [{
                ...
                }], avatar: '', totalAsset: tools_1.formatBalanceValue(tools_1.fetchLocalTotalAssets() + tools_1.fetchCloudTotalAssets()), refreshing: false });
        }
    }, {
        key: "tabsChangeClick",
