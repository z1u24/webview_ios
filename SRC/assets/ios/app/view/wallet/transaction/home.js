...
var TransactionHome = function (_widget_1$Widget) {
    ...
    _createClass(TransactionHome, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { balance: balance, balanceValue: tools_1.formatBalanceValue(balanceValue), rate: tools_1.formatBalanceValue(tools_1.fetchBalanceValueOfCoin(currencyName, 1)), txList: txList,
                canConvert: canConvert, redUp: color === 'redUp', currencyUnitSymbol: tools_1.getCurrencyUnitSymbol(), tabs: [{
                    tab: '全部',
                    list: txList
                }, {
                    tab: '转账',
        ...
        value: function txListItemClick(e, index) {
            root_1.popNew('app-view-wallet-transaction-transactionDetails', { hash: this.props.txList[index].hash });
        }
        // 转账
        ...
        value: function updateRate() {
            this.props.rate = tools_1.formatBalanceValue(tools_1.fetchBalanceValueOfCoin(this.props.currencyName, 1));
            this.paint();
        }
    }, {
        ...
        value: function currencyUnitChange() {
            this.props.rate = tools_1.formatBalanceValue(tools_1.fetchBalanceValueOfCoin(this.props.currencyName, 1));
            this.props.balanceValue = tools_1.formatBalanceValue(tools_1.fetchBalanceValueOfCoin(this.props.currencyName, this.props.balance));
