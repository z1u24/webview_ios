    ...
    _createClass(Transfer, [{
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                this.props = Object.assign({}, this.props, { fromAddr: tools_1.getCurrentAddrByCurrencyName(this.props.currencyName), toAddr: tx ? tx.toAddr : '', amount: tx ? tx.pay : 0, balance: tools_1.formatBalance(tools_1.getCurrentAddrInfo(this.props.currencyName).balance), minerFee: minerFeeList[curLevel].minerFee, minerFeeList: minerFeeList,
                                    curLevel: curLevel, minLevel: curLevel, inputDisabled: tx ? true : false, amountShow: '0.00', currencyUnitSymbol: tools_1.getCurrencyUnitSymbol() });
        ...
        value: function chooseMinerFee() {
            ...
            root_1.popNew('app-components-allModalBox-chooseModalBox', {
                ...
                _this3.props.curLevel = _this3.props.minerFeeList[index].level;
                _this3.props.minerFee = _this3.props.minerFeeList[index].minerFee;
                _this3.paint();
            });
        }
        // 收款地址变化
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 6:
                                ...
                                if (!(this.props.balance < Number(this.props.amount) || this.props.minerFee > tools_1.getCurrentAddrInfo('ETH').balance)) {
                                    _context3.next = 10;
                                    break;
                                }
                            ...
                            case 15:
                                if (tools_1.judgeAddressAvailable(this.props.currencyName, this.props.toAddr)) {
                                    _context3.next = 18;
                                    break;
                                }
                            ...
                            case 18:
                                minerFeeLevel = this.props.curLevel;
                                currencyName = this.props.currencyName;
                                fromAddr = this.props.fromAddr;
                                toAddr = this.props.toAddr;
                                pay = Number(this.props.amount);
                                txPayload = {
                                    fromAddr: fromAddr,
                                    toAddr: toAddr,
                                    pay: pay,
