...
var WalletHome = function (_widget_1$Widget) {
    ...
    _createClass(WalletHome, [{
        ...
        value: function setProps(props, oldProps) {
            _get(WalletHome.prototype.__proto__ || Object.getPrototypeOf(WalletHome.prototype), "setProps", this).call(this, props, oldProps);
            this.init();
        }
    }, {
        key: "init",
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { totalAsset: tools_1.formatBalanceValue(tools_1.fetchLocalTotalAssets()), assetList: tools_1.fetchWalletAssetList(), redUp: color === 'redUp', currencyUnitSymbol: tools_1.getCurrencyUnitSymbol() });
            // console.log('updateTest');
        }
    }, {
        key: "updateBalance",
        value: function updateBalance() {
            this.props.totalAsset = tools_1.formatBalanceValue(tools_1.fetchLocalTotalAssets());
            this.props.assetList = tools_1.fetchWalletAssetList();
            this.paint();
        }
        // 添加资产
