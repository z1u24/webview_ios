...
var CloudHome = function (_widget_1$Widget) {
    ...
    _createClass(CloudHome, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { totalAsset: tools_1.formatBalanceValue(tools_1.fetchCloudTotalAssets()), assetList: tools_1.fetchCloudWalletAssetList(), productList: memstore_1.getStore('activity/financialManagement/products', []), redUp: color === 'redUp', currencyUnitSymbol: tools_1.getCurrencyUnitSymbol() });
        ...
        value: function itemClick(e) {
            ...
            var index = e.index;
            var v = this.props.assetList[index];
            if (v.currencyName === 'ST') {
                root_1.popNew('app-view-wallet-cloudWalletGT-home', { currencyName: v.currencyName, gain: v.gain });
            } else {
        ...
        value: function updateBalance() {
            this.props.totalAsset = tools_1.formatBalanceValue(tools_1.fetchCloudTotalAssets());
            this.props.assetList = tools_1.fetchCloudWalletAssetList();
            this.paint();
        }
    }, {
        key: "optimalClick",
        value: function optimalClick() {
            root_1.popNew('app-view-wallet-financialManagement-home', { activeNum: 0 });
        }
    }, {
        key: "fmItemClick",
