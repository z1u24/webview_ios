...
var Withdraw = function (_widget_1$Widget) {
    ...
    _createClass(Withdraw, [{
        ...
        value: function init() {
            ...
            var balance = memstore_1.getCloudBalances().get(interface_1.CloudCurrencyType[currencyName]);
            this.props = Object.assign({}, this.props, { balance: balance, amount: 0, minerFee: minerFee, withdrawAddr: tools_1.getCurrentAddrInfo(currencyName).addr, withdrawAddrInfo: this.parseAddrsInfo() });
        }
    }, {
        key: "backPrePage",
        ...
        value: function chooseWithdrawAddr() {
            ...
            root_1.popNew('app-view-wallet-components-choosetWithdrawAddr', { addrsInfo: this.props.withdrawAddrInfo }, function (index) {
                var addrsInfo = _this2.props.withdrawAddrInfo;
                for (var i = 0; i < addrsInfo.length; i++) {
                    if (i === index) {
                        addrsInfo[i].isChoosed = true;
                        _this2.props.withdrawAddr = addrsInfo[i].addr;
                    } else {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                tools_1.popNewMessage(this.language.tips[0] + limit + currencyName);
                            ...
                            case 17:
                                _context.next = 19;
                                return pullWallet_1.withdraw(passwd, this.props.withdrawAddr, this.props.currencyName, this.props.amount);
