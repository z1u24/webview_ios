    ...
    _createClass(Recharge, [{
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                this.props = Object.assign({}, this.props, { fromAddr: tools_1.getCurrentAddrByCurrencyName(this.props.currencyName), amount: tx ? tx.pay : 0, balance: tools_1.formatBalance(tools_1.getCurrentAddrInfo(this.props.currencyName).balance), minerFee: minerFeeList[curLevel].minerFee, minerFeeList: minerFeeList,
                                    curLevel: curLevel, minLevel: curLevel, inputDisabled: tx ? true : false });
        ...
        value: function chooseMinerFee() {
            ...
            root_1.popNew('app-components-allModalBox-chooseModalBox', {
                ...
                _this2.props.curLevel = _this2.props.minerFeeList[index].level;
                _this2.props.minerFee = _this2.props.minerFeeList[index].minerFee;
                _this2.paint();
            });
        }
        // 转账
