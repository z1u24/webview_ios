(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 2;_node.attrHash = 138104688;_node.attrs["class"] = "new-page";_node.attrs["w-class"] = "new-page";_$temp = _node;{
			var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "div", "sid": 1 };_node2.children = [];_node2.attrSize = 3;_node2.attrHash = 2146907349;_node2.attrs["w-class"] = "main";_node2.attrs["on-scroll"] = "getMoreList";_node2.attrs["id"] = "withdraw-scroller-container";if (it.recordList.length <= 0) {
				_$temp = _node2;{
				...
				var _$parent8 = _$temp;var _node8 = { "attrs": {}, "tagName": "div", "sid": 6 };_node8.children = [];_node8.attrSize = 2;_node8.attrHash = 2661893624;_node8.attrs["w-class"] = "record-list";_node8.attrs["id"] = "withdraw-content-container";{
					var _$i = 0;
					for (var _iterator = it.recordList, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
						var _ref;
						...
						var i = _$i++;_$temp = _node8;{
							...
							}_node9.attrHash = _hash.nextHash(_node9.attrHash, _calTextHash(_node9.attrs["on-tap"]));_node9.attrs["w-class"] = "item-container";_$temp = _node9;{
