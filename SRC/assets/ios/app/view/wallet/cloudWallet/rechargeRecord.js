...
var RechargeRecord = function (_widget_1$Widget) {
    ...
    _createClass(RechargeRecord, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { recordList: [], nextStart: rechargeLogs.start, canLoadMore: rechargeLogs.canLoadMore, isRefreshing: false });
        ...
        value: function updateTransaction() {
            var list = this.props.recordList;
            list.forEach(function (item) {
                var txDetail = walletTools_1.fetchLocalTxByHash1(item.hash);
                var obj = tools_1.parseStatusShow(txDetail);
                item.statusShow = obj.text;
        ...
        value: function loadMore() {
            pull_1.getRechargeLogs(this.props.currencyName, this.props.nextStart);
        }
    }, {
        key: "getMoreList",
