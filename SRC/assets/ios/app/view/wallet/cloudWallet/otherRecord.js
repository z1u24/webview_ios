...
var OtherRecord = function (_widget_1$Widget) {
    ...
    _createClass(OtherRecord, [{
        ...
        value: function init() {
            ...
            var accountDetail = memstore_1.getStore('cloud/cloudWallets').get(interface_1.CloudCurrencyType[this.props.currencyName]).otherLogs;
            this.props = Object.assign({}, this.props, { recordList: this.parseRecordList(accountDetail.list), nextStart: accountDetail.start, canLoadMore: accountDetail.canLoadMore, isRefreshing: false });
        }
    }, {
        ...
        value: function loadMore() {
            pull_1.getAccountDetail(this.props.currencyName, 1, this.props.nextStart);
        }
    }, {
        key: "getMoreList",
