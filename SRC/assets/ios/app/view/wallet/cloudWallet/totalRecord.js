...
var TotalRecord = function (_widget_1$Widget) {
    ...
    _createClass(TotalRecord, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { recordList: [], otherList: [], rechargeList: [], withdrawList: [], otherNext: 0, rechargeNext: 0, withdrawNext: 0, canLoadMore: false, isRefreshing: false });
        ...
        value: function recordListItemClick(e, index) {
            if (this.props.recordList[index].hash) {
                root_1.popNew('app-view-wallet-transaction-transactionDetails', { hash: this.props.recordList[index].hash });
            }
        }
        /**
         * 请求更多数据
        ...
        value: function loadMore() {
            ...
            pull_1.getWithdrawLogs(this.props.currencyName, this.props.withdrawNext);
            pull_1.getRechargeLogs(this.props.currencyName, this.props.rechargeNext);
        }
        /**
         * 加载更多数据
         */
