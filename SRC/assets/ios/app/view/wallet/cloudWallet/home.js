    ...
    _createClass(CloudWalletHome, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { tabs: [{
                ...
                }], activeNum: 0, gain: tools_1.fetchCoinGain(currencyName), rate: tools_1.formatBalanceValue(tools_1.fetchBalanceValueOfCoin(currencyName, 1)), balance: balance,
        ...
        value: function updateBalance() {
            ...
            this.props.balanceValue = tools_1.formatBalanceValue(tools_1.fetchBalanceValueOfCoin(currencyName, this.props.balance));
            this.paint();
        }
    }, {
        key: "tabsChangeClick",
        ...
        value: function rechargeClick() {
            if (this.props.currencyName === 'KT') {
                root_1.popNew('app-view-wallet-cloudWallet-rechargeKT');
