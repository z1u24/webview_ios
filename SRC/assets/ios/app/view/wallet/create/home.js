...
var CreateEnter = function (_widget_1$Widget) {
    ...
    _createClass(CreateEnter, [{
        ...
        value: function delUserAccount(e, index) {
            var delAccount = this.props.accountList.splice(index, 1)[0];
        ...
        value: function createStandardClick() {
            root_1.popNew('app-view-wallet-create-createWallet', { itype: localWallet_1.CreateWalletType.Random });
        }
    }, {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                ...
                                account = walletList[this.props.selectedAccountIndex];

                                console.log(this.props.psw);
                                _context.next = 9;
                                return walletTools_1.VerifyIdentidy1(this.props.psw, account.wallet.vault, account.user.salt);
