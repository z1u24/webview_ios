...
var ShareMnemonic = function (_widget_1$Widget) {
    ...
    _createClass(ShareMnemonic, [{
        ...
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { encryptFragments: encryptFragments,
                successList: successList, walletName: modulConfig_1.getModulConfig('WALLET_NAME') });
        }
        // 分享
        ...
        value: function shareItemClick(e, index) {
            ...
            var fragment = this.props.encryptFragments[index];
            root_1.popNew('app-components-share-share', { text: fragment, shareType: shareToPlatforms_1.ShareToPlatforms.TYPE_IMG }, function (success) {
                _this2.props.successList[index] = true;
                _this2.paint();
                _this2.allShared();
            });
        }
        ...
        value: function allShared() {
            var allShared = true;
            for (var i = 0; i < this.props.successList.length; i++) {
