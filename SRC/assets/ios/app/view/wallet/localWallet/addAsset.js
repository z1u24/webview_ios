...
var AddAsset = function (_widget_1$Widget) {
    ...
    _createClass(AddAsset, [{
        ...
        value: function onSwitchChange(e, index) {
            var added = e.newType;
            var currencys = this.props.showAssetList[index];
        ...
        value: function searchTextChange(e) {
            ...
            if (this.props.searchText) {
                ...
                this.props.showAssetList = this.props.assetList.filter(function (v) {
                    return v.currencyName.toLowerCase().indexOf(_this2.props.searchText.toLowerCase()) >= 0;
                });
            } else {
