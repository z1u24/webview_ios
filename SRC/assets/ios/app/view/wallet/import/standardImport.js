...
var StandardImport = function (_widget_1$Widget) {
    ...
    _createClass(StandardImport, [{
        ...
        value: function nextClick(e) {
            ...
            if (!genmnemonic_1.isValidMnemonic(constants_1.lang, this.props.mnemonic)) {
            ...
            root_1.popNew('app-view-wallet-create-createWallet', { itype: localWallet_1.CreateWalletType.StrandarImport, mnemonic: this.props.mnemonic });
        }
    }]);
