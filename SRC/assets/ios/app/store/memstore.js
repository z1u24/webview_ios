...
var initFile = function initFile() {
    return new Promise(function (resolve) {
        filestore_1.initFileStore().then(function () {
            var txHistoryPromise = initTxHistory(); // 历史记录初始化
            // const activityPromise = initActivity();         // 活动初始化
            Promise.all([txHistoryPromise]).then(function () {
                resolve();
            });
        });
    });
 ...
 */
var initTxHistory = function initTxHistory() {
    return new Promise(function (resolve) {
        if (!store.user.id) {
            resolve();
            return;
...
var initSettings = function initSettings() {
    ...
    var setting = filestore_1.getLocalStorage('setting', {
        ...
        deviceId: '',
        topHeight: constants_1.topHeight,
        bottomHeight: 0
    });
...
var initActivity = function initActivity() {
    return new Promise(function (resolve) {
        filestore_1.getFile('activity', function (activity) {
            console.log('activity read success = ', activity);
            store.activity = Object.assign({}, store.activity, activity);
            resolve();
        }, function () {
 ...
 * 活动数据变化监听
 */
var registerActivityChange = function registerActivityChange() {
    exports.register('activity', function () {
        activityChange();
    });
};
/**
 ...
 * 活动数据变化
 */
var activityChange = function activityChange() {
    // setLocalStorage('activity', store.activity);
    filestore_1.writeFile('activity', store.activity);
};
/**
 * 第3方数据变化
 */
var thirdChange = function thirdChange() {
    var localThird = {
        ...
        goldPrice: exports.getStore('third/goldPrice'),
...
var settingChange = function settingChange() {
    var localSetting = {
        ...
        deviceId: exports.getStore('setting/deviceId'),
        deviceInfo: exports.getStore('setting/deviceInfo'),
        topHeight: exports.getStore('setting/topHeight'),
        bottomHeight: exports.getStore('setting/bottomHeight')
    };
