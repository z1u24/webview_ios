...
exports.parseCloudAccountDetail = function (coinType, infos) {
    ...
    infos.forEach(function (v) {
        var itype = v[0];
        var amount = unitTools_1.smallUnit2LargeUnit(coinType, v[1]);
        var behavior = '';
        var behaviorIcon = '';
        switch (itype) {
            case interface_1.TaskSid.Mine:
            ...
            case interface_1.TaskSid.LuckyMoneyRetreat:
                ...
                behaviorIcon = 'behavior_red_bag.png';
                break;
            case interface_1.TaskSid.Wxpay:
                behavior = tools_1.getStaticLanguage().cloudAccountDetail.types[8];
                behaviorIcon = 'wxpay_rechange.png';
                break;
            case interface_1.TaskSid.Alipay:
                behavior = tools_1.getStaticLanguage().cloudAccountDetail.types[9];
 ...
 * 解析GT流水
 */
exports.splitGtAccountDetail = function (list) {
    var res = {
        rechangeList: [],
        withdrawList: []
    };
    list.forEach(function (v) {
        if (v.itype === interface_1.TaskSid.Wxpay || v.itype === interface_1.TaskSid.Alipay) {
