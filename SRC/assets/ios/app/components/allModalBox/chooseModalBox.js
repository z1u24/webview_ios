_$define("app/components/allModalBox/chooseModalBox", function (require, exports, module){
"use strict";
...
var ChooseModalBox = function (_widget_1$Widget) {
    ...
    _createClass(ChooseModalBox, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { minerFeeList: this.props.minerFeeList, level: this.props.curLevel ? this.props.curLevel : interface_1.MinerFeeLevel.Standard });
        }
    }, {
        key: "chooseMinerLevel",
        value: function chooseMinerLevel(e, index) {
            var chooseLevel = this.props.minerFeeList[index].level;
