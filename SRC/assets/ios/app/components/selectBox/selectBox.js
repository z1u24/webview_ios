...
var SelectBox = function (_widget_1$Widget) {
    ...
    _createClass(SelectBox, [{
        ...
        value: function setProps(oldProps, newProps) {
            ...
            this.props = Object.assign({}, this.props, { showList: false, list: this.props.list, selected: this.props.selected });
        }
    }, {
        key: "backPrePage",
        ...
        value: function changeSelect(e, ind) {
            ...
            event_1.notify(e.node, 'ev-selectBox-change', { selected: this.props.selected });
            this.paint();
        }
        /**
         * 展示下拉列表
