...
var ImgRankItem = function (_widget_1$Widget) {
    ...
    _createClass(ImgRankItem, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { password: '', secret: 0, showTips: false, isSuccess: false, showIcon: false });
        }
    }, {
        key: "backPrePage",
        ...
        value: function clear(event) {
            ...
            this.props.secret = 0;
            this.props.showIcon = false;
            event_1.notify(event.node, 'ev-psw-clear', {});
            this.paint(true);
        }
        /**
         * 判断密码强度
