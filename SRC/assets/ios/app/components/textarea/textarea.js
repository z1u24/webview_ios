_$define("app/components/textarea/textarea", function (require, exports, module){
"use strict";
...
var Input = function (_widget_1$Widget) {
    ...
    _createClass(Input, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { currentValue: currentValue, hovering: false, focused: false, showClear: this.showClear.bind(this), styleStr: styleStr });
        }
    }, {
        key: "change",
        value: function change(event) {
            ...
            event_1.notify(event.node, 'ev-input-change', { value: this.props.currentValue });
        ...
        value: function showClear() {
            ...
            return this.props && this.props.clearable && !this.props.disabled && this.props.currentValue !== '' && (this.props.focused || this.props.hovering);
        }
        // 清空文本框
        ...
        value: function changeInputValue() {
            ...
            childNode.value = this.props.currentValue;
        }
    }]);
