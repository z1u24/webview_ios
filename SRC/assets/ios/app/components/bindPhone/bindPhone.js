...
var BindPhone = function (_widget_1$Widget) {
    ...
    _createClass(BindPhone, [{
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 4:
                                _context.next = 6;
                                return pull_1.sendCode(this.props.phone, this.props.oldCode);

                            case 6:
                                // updateStore('lastGetSmsCodeTime', new Date().getTime());
                                event_1.notify(event.node, 'ev-getCode', { value: this.props.phone });
        ...
        value: function openTimer() {
            ...
            setTimeout(function () {
                _this2.openTimer();
                if (_this2.props.countdown <= 0) return;
                _this2.props.countdown--;
                _this2.paint();
            }, 1000);
        }
    }]);
