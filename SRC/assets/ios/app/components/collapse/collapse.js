_$define("app/components/collapse/collapse", function (require, exports, module){
"use strict";
...
var Collapse = function (_widget_1$Widget) {
    ...
    _createClass(Collapse, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            if (props.accordion) {
                this.props = Object.assign({}, this.props, { currentExpIndex: -1, lastExpIndex: -1, isExpanded: this.isExpanded.bind(this) });
            } else {
                var currentExpArr = [];
                for (var i = 0; i < props.collapseList.length; i++) {
                    currentExpArr[i] = false;
                }
                this.props = Object.assign({}, this.props, { currentExpArr: currentExpArr, isExpanded: this.isExpanded.bind(this) });
            }
        }
    }, {
        ...
        value: function clickItemListener(event, index) {
            ...
            if (this.props.accordion) {
                ...
                activeIndexs = [];
                for (var i = 0; i < this.props.currentExpArr.length; i++) {
        ...
        value: function setHiddenContentHeight(index, isExpanded) {
            ...
            if (this.props.accordion && this.props.lastExpIndex !== -1) {
                var lastItemPanel = this.tree.children[this.props.lastExpIndex].children[1];
        ...
        key: "itemClick",
        value: function itemClick(e, collapseListIndex, textListIndex) {
            event_1.notify(e.node, 'ev-collapse-item-click', { collapseListIndex: collapseListIndex, textListIndex: textListIndex });
        }
    }]);
