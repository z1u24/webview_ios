...
var ModalBoxInput = function (_widget_1$Widget) {
    ...
    _createClass(ModalBoxInput, [{
        ...
        value: function setProps(props, oldProps) {
            _get(ModalBoxInput.prototype.__proto__ || Object.getPrototypeOf(ModalBoxInput.prototype), "setProps", this).call(this, props, oldProps);
            this.language = this.config.value[lang_1.getLang()];
            this.props = Object.assign({}, this.props, { currentValue: '' });
        }
        /**
         * 点击取消按钮
         */
