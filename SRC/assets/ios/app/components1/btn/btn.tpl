(function (_cfg, it, it1) {
  var _$temp = void 0,
    ...
    var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 3111596878;{
      ...
      var _attrvalue = "";_attrvalue += it.style ? it.style : '';_attrvalue += " animation:";_attrvalue += it.isAbleBtn ? 'btnClick 0.2s' : '';_attrvalue += "";_node.attrs["style"] = _attrvalue;
    }_node.attrHash = _hash.nextHash(_node.attrHash, _calTextHash(_node.attrs["style"]));if (it.isString) {
      _$temp = _node;{
