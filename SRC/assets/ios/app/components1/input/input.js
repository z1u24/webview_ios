...
var Input = function (_widget_1$Widget) {
    ...
    _createClass(Input, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { currentValue: currentValue, itype: props.itype || 'text', focused: false, showClear: false, inputLock: false });
        }
        /**
         * 绘制方法
        ...
        value: function paint(reset) {
            ...
            this.getInput().value = this.props.currentValue;
        ...
        value: function onBlur(event) {
            ...
            event_1.notify(event.node, 'ev-input-blur', { value: this.props.currentValue });
            this.paint();
        }
        /**
         * 聚焦事件
