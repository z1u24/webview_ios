...
var LockScreenPage = function (_widget_1$Widget) {
    ...
    _createClass(LockScreenPage, [{
        ...
        value: function setProps(props, oldProps) {
            this.props = Object.assign({}, props, { pi_norouter: true });
            _get(LockScreenPage.prototype.__proto__ || Object.getPrototypeOf(LockScreenPage.prototype), "setProps", this).call(this, this.props, oldProps);
            this.init();
        }
    }, {
        key: "init",
        value: function init() {
            ...
            this.props = Object.assign({}, this.props, { errorTips: this.language.errorTips, lockScreenPsw: '', openLockScreen: false, loading: false });
        ...
        value: function reSetLockPsw() {
            ...
            root_1.popNew('app-components1-keyboard-keyboard', { title: this.language.keyboardTitle[1] }, function (r) {
                if (_this3.props.lockScreenPsw !== r) {
        ...
        value: function unLockScreen(ind) {
            ...
            if (ls.locked || ind > 2) {
                ...
                var title = this.props.errorTips[ind === 0 ? 3 : ind];
