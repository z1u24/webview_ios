_$define("app/components1/loading/loading1", function (require, exports, module){
"use strict";
...
var Loading = function (_widget_1$Widget) {
    ...
    _createClass(Loading, [{
        ...
        value: function setProps(props, oldProps) {
            ...
            this.props = Object.assign({}, this.props, { pi_norouter: true, startTime: new Date().getTime() });
        }
    }, {
        key: "close",
        value: function close() {
            ...
            var interval = endTime - this.props.startTime;
