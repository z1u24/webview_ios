    ...
    if (!str) {
        switch (result) {
            ...
            case 2033:
                ...
                break;
            case 3001:
                str = tools_1.getStaticLanguage().errorList[3001];
                break;
            case 3002:
                str = tools_1.getStaticLanguage().errorList[3002];
                break;
            case 3003:
                str = tools_1.getStaticLanguage().errorList[3003];
                break;
            case 3004:
                str = tools_1.getStaticLanguage().errorList[3004];
                break;
            case 3005:
                str = tools_1.getStaticLanguage().errorList[3005];
                break;
            case 3101:
                str = tools_1.getStaticLanguage().errorList[3101];
                break;
            case 3102:
                str = tools_1.getStaticLanguage().errorList[3102];
                break;
            case 3103:
                str = tools_1.getStaticLanguage().errorList[3103];
                break;
            case 3104:
                str = tools_1.getStaticLanguage().errorList[3104];
                break;
            case 3201:
                str = tools_1.getStaticLanguage().errorList[3201];
                break;
            case 3202:
                str = tools_1.getStaticLanguage().errorList[3202];
                break;
            case 3203:
                str = tools_1.getStaticLanguage().errorList[3203];
                break;
            case -99:
