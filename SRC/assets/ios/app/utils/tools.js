            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 9:
                        ...
                        return _context.abrupt("return", secretHash);
...
exports.fetchBalanceValueOfCoin = function (currencyName, balance) {
    var balanceValue = 0;
    var USD2CNYRate = memstore_1.getStore('third/rate', 1);
    var currency2USDT = memstore_1.getStore('third/currency2USDTMap').get(currencyName) || { open: 0, close: 0 };
    var currencyUnit = memstore_1.getStore('setting/currencyUnit', 'CNY');
    var goldPrice = memstore_1.getStore('third/goldPrice/price') || 0;
    if (currencyUnit === 'CNY') {
        if (currencyName === 'ST') {
...
exports.fetchCloudWalletAssetList = function () {
    var assetList = [];
    var cloudBalances = memstore_1.getCloudBalances();
    var ktBalance = cloudBalances.get(interface_1.CloudCurrencyType.KT) || 0;
    var ktItem = {
        currencyName: 'KT',
        ...
        rate: exports.formatBalanceValue(0)
    };
    assetList.push(ktItem);
    var gtBalance = cloudBalances.get(interface_1.CloudCurrencyType.ST) || 0;
    var gtItem = {
        currencyName: 'ST',
        description: 'ST',
        balance: exports.formatBalance(gtBalance),
        balanceValue: exports.formatBalanceValue(exports.fetchBalanceValueOfCoin('ST', gtBalance)),
        gain: exports.fetchGTGain(),
        rate: exports.formatBalanceValue(exports.fetchBalanceValueOfCoin('ST', 1))
    };
...
exports.hasWallet = function () {
    var wallet = memstore_1.getStore('wallet');
    if (!wallet) {
        root_1.popNew('app-components1-modalBox-toLoginBox', undefined, function () {
...
exports.fetchGTGain = function () {
    var goldGain = memstore_1.getStore('third/goldPrice/change');
    if (!goldGain) {
        return exports.formatBalanceValue(0);
    } else {
        return exports.formatBalanceValue(goldGain * 100);
    }
};
/**
 * 转化rtype
...
exports.imgResize = function (buffer, callback) {
    ...
    fr.onload = function () {
        ...
        resize_1.resize({ url: dataUrl, width: 140, ratio: 0.3, type: 'jpeg' }, function (res) {
                ...
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        return _context3.abrupt("return", new Promise(function (resolve, reject) {
                            var deviceId = math_1.cryptoRandomInt().toString();
                            var hash256 = exports.sha256(deviceId);
                            resolve(hash256);
                        }));
 ...
 * 获取设备信息
 */
exports.fetchDeviceInfo = function () {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 5:
                        return _context4.abrupt("return", new Promise(function (resolve, reject) {
                            native_1.getDeviceInfo(function (info) {
...
exports.loginSuccess = function (account) {
    ...
    var currencyRecords = [];
    for (var _iterator14 = localWallet.currencyRecords, _isArray14 = Array.isArray(_iterator14), _i19 = 0, _iterator14 = _isArray14 ? _iterator14 : _iterator14[Symbol.iterator]();;) {
        var _ref16;

        if (_isArray14) {
            if (_i19 >= _iterator14.length) break;
            _ref16 = _iterator14[_i19++];
        } else {
        ...
        var localRecord = _ref16;

        var addrs = [];
        for (var _iterator16 = localRecord.addrs, _isArray16 = Array.isArray(_iterator16), _i21 = 0, _iterator16 = _isArray16 ? _iterator16 : _iterator16[Symbol.iterator]();;) {
            var _ref18;

            if (_isArray16) {
                if (_i21 >= _iterator16.length) break;
                _ref18 = _iterator16[_i21++];
            } else {
    ...
    for (var _iterator15 = localCloudWallets, _isArray15 = Array.isArray(_iterator15), _i20 = 0, _iterator15 = _isArray15 ? _iterator15 : _iterator15[Symbol.iterator]();;) {
        var _ref17;

        if (_isArray15) {
            if (_i20 >= _iterator15.length) break;
            _ref17 = _iterator15[_i20++];
        } else {
    ...
    memstore_1.setStore('cloud', cloud, false);
    memstore_1.setStore('user', user);
    memstore_1.setStore('flags', { level_2_page_loaded: true });
    pull_1.openConnect();
};
/**
 * 获取用户基本信息
 ...
 * @param secretHash 密码
 */
exports.kickOffline = function () {
    var secretHash = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    ...
    root_1.popNew('app-components1-modalBoxCheckBox-modalBoxCheckBox', {
        ...
        if (deleteAccount) {
            pull_1.getRandom(secretHash, constants_1.CMD.FORCELOGOUTDEL);
        } else {
            pull_1.getRandom(secretHash, constants_1.CMD.FORCELOGOUT);
        }
    }, function () {
        pull_1.getRandom(secretHash, constants_1.CMD.FORCELOGOUT);
    });
