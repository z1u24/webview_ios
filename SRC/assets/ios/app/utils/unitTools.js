...
exports.smallUnit2LargeUnit = function (currencyName, amount) {
    ...
    if (currencyName === 'ETH') {
        ...
        ret = exports.wei2Eth(parseInt(amount.toString()));
    } else if (currencyName === 'KT') {
        // tslint:disable-next-line:radix
        ret = exports.kpt2kt(parseInt(amount.toString()));
    } else if (currencyName === 'BTC') {
        // tslint:disable-next-line:radix
        ret = exports.sat2Btc(parseInt(amount.toString()));
    } else if (currencyName === 'ST') {
        ret = parseInt(amount.toString(), 16) / 1000000;
    } else {
        // erc20
        // tslint:disable-next-line:radix
        ret = exports.ethTokenDivideDecimals(parseInt(amount.toString()), currencyName);
    }
    return tools_1.formatBalance(ret);
};
/**
 * 根据货币类型大单位转小单位
 */
...
exports.sat2Btc = function (num) {
    num = Number(num);
    return tools_1.formatBalance(num / Math.pow(10, 8));
};
/**
 * btc转sat
 */
