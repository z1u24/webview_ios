...
exports.getMnemonic = function (passwd) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var wallet, hash, cipher, r, mnemonic;
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 3:
                        ...
                        mnemonic = genmnemonic_1.toMnemonic(constants_1.lang, tools_1.hexstrToU8Array(r));
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 8:
                        _context4.next = 10;
                        return pull_1.buyProduct(productId, amount, secretHash);
