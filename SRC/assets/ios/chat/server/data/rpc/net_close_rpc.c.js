_$define("chat/server/data/rpc/net_close_rpc.c", function (require, exports, module){
"use strict";
...
var arr = [[0, _$c("chat/server/data/rpc/net_close.close_connect", new Map([["event", "net_connect_close"]]))]];
