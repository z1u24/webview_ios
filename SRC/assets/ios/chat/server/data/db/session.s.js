_$define("chat/server/data/db/session.s", function (require, exports, module){
"use strict";
...
Session._$info = new sinfo_1.StructInfo("chat/server/data/db/session.Session", 1262724924, null, [new sinfo_1.FieldInfo("key", new sinfo_1.EnumType(sinfo_1.Type.Str), null), new sinfo_1.FieldInfo("value", new sinfo_1.EnumType(sinfo_1.Type.Str), null)]);
...
SessionTab._$info = new sinfo_1.StructInfo("chat/server/data/db/session.SessionTab", 966153170, new Map([["primary", "id"], ["db", "memory"]]), [new sinfo_1.FieldInfo("id", new sinfo_1.EnumType(sinfo_1.Type.Str), null), new sinfo_1.FieldInfo("sessions", new sinfo_1.EnumType(sinfo_1.Type.Arr, new sinfo_1.EnumType(sinfo_1.Type.Struct, Session._$info)), null)]);
