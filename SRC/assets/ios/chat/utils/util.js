_$define("chat/utils/util", function (require, exports, module){
"use strict";
/**
 * 一些通用方法
 */
 ...
 * 删除申请或邀请加入群的群ID
 */
exports.delGidFromApplygroup = function (gid, arr) {
    return arr.filter(function (ele) {
        return exports.getGidFromGuid(ele) !== gid;
    });
};
/**
 * generate next index
 ...
 */
exports.getGidFromHincid = function (hIncId) {
