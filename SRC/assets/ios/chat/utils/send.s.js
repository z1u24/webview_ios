_$define("chat/utils/send.s", function (require, exports, module){
"use strict";
...
SendMsg._$info = new sinfo_1.StructInfo("chat/utils/send.SendMsg", 2898385964, null, [new sinfo_1.FieldInfo("cmd", new sinfo_1.EnumType(sinfo_1.Type.Str), null), new sinfo_1.FieldInfo("msg", new sinfo_1.EnumType(sinfo_1.Type.Str), null)]);
