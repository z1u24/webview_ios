(function (_cfg, it, it1) {
	var _$temp = void 0,
	    node = void 0;var membersButnoOwnerAdmins = it.ginfo.memberids.filter(function (item) {
		return item !== it.ginfo.ownerid && it.ginfo.adminids.indexOf(item) === -1;
	});_$temp = node;{
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 1;_node.attrHash = 1542886283;_node.attrs["class"] = "new-page";_$temp = _node;{
			var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "div", "sid": 1 };_node2.children = [];_node2.childHash = 1534312214;_node2.attrSize = 2;_node2.attrHash = 1849330599;_node2.attrs["ev-back-click"] = "goBack";_node2.attrs["ev-next-click"] = "completeAddAdmin";_$temp = _node2;{
				var _$parent3 = _$temp;var _node3 = { "attrs": {}, "tagName": "chat-client-app-widget-topBar-topBar", "sid": 2 };_node3.hasChild = false;_node3.child = null;_node3.childHash = 3682665282;_node3.attrHash = 0;_$temp = _node3;{
			...
			var _$parent9 = _$temp;var _node9 = { "attrs": {}, "tagName": "div", "sid": 6 };_node9.children = [];_node9.attrSize = 2;_node9.attrHash = 1667031585;_node9.attrs["w-class"] = "a-part";_node9.attrs["ev-changeSelect"] = "changeSelect";_$temp = _node9;{
				...
				var _$i = 0;
				for (var _iterator = membersButnoOwnerAdmins, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
					var _ref;
					...
					var index = _$i++;_$temp = _node9;{
						var _$parent12 = _$temp;var _node12 = { "attrs": {}, "tagName": "div", "sid": 8 };_node12.children = [];_node12.attrSize = 1;_node12.attrHash = 1479626886;_node12.attrs["ev-addMember"] = "addAdminMember";_$temp = _node12;{
