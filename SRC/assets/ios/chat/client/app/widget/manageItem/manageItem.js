_$define("chat/client/app/widget/manageItem/manageItem", function (require, exports, module){
"use strict";
/**
 * manageItem 组件相关处理
 */
...
var ManageItem = function (_widget_1$Widget) {
    ...
    _createClass(ManageItem, [{
        key: "openManageItem",
        value: function openManageItem(e, index) {
            event_1.notify(e.node, 'ev-openManageItem', { value: index });
        }
    }]);
