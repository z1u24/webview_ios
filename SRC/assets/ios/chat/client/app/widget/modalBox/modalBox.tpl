(function (_cfg, it, it1) {
  var _$temp = void 0,
    ...
    var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 3920909828;_node.attrs["w-class"] = "modal-mask";_node.attrs["class"] = "new-page";_node.attrs["style"] = "position:absolute;width:100%;height:100%;top:0px;left:0px;";_$temp = _node;{
      var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "div", "sid": 1 };_node2.children = [];_node2.attrSize = 1;_node2.attrHash = 4252679546;_node2.attrs["w-class"] = "body";if (it.title) {
        _$temp = _node2;{
