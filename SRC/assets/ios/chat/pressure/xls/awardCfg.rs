...
#[db=memory,readonly=true,primary=id]struct WeightAwardCfg{ id: u32, prop: u32, min: u32, max: u32, count: u32, limit: u32, weight: u32, module: str, func: str, arg: str, note: str, }
