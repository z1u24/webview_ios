_$define("pi_pt/async/async_resp", function (require, exports, module){
"use strict";
...
exports.Path = "pi_pt/async/async_resp";
//写入一个数组
...
exports.readArray = function (bb, nobjs) {
    ...
    return bb.readCt(function (bb, t) {
...
exports.readany = function (bb, nobjs) {
    ...
    if (t === 255) {
        ...
        var meta = structMgr.lookup(t_hash);
        return new meta.construct(nobjs[index]);
    } else {
        var a = util_1.read(bb, structMgr);
        return a;
    }
};
//根据参数个数不同， 使用不同的调用方式
...
var request = function request(path, args, nobjs, callbackIndex, mgr, vmChannel) {
    //console.log(nobjs, nobjs.length);
    env = new env_1.Env(new mgr_1.Mgr(mgr), null);
    //解析接口路径
