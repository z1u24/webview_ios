_$define("pi_pt/async/async", function (require, exports, module){
"use strict";
...
exports.asyncCall = function (name, args, callback) {
    var back = function back(r, nobjs) {
        callback(util_1.readany(new bon_1.BonBuffer(r), nobjs)); //解析返回值， 调用回调
    };
    //序列化参数
    var index = vm_1.callbacks.register(back);
    var bb = new bon_1.BonBuffer();
    var nobjs = [];
    util_1.writeArray(args, bb, nobjs);
    //异步掉用
...
exports.syncCall = function (name, args) {
    ...
    return util_1.readany(new bon_1.BonBuffer(r[0]), r[1]);
};
})