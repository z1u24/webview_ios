_$define("pi_pt/vm/vm", function (require, exports, module){
    ...
    exports.syncCall = function(funHash, args){
        //try {
            ...
            if(r === undefined){
                ...
                if(!a){
                    //console.log("rrrrrrrrrrrrrrrrrrrrrrrrrrrrrkkkkkkkkkkkkkkkkkkkkkkkkkkk111111111", self._$rust_r);
                    a = self._$rust_r;
                    self._$rust_r = undefined;
                }
                return a;
            }else{
                return r;
