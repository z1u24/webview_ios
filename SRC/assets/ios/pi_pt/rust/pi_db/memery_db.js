_$define("pi_pt/rust/pi_db/memery_db", function (require, exports, module){
"use strict";
...
DB._$info = new sinfo_1.StructInfo("pi_pt/rust/pi_db/memery_db.DB", 3089884990, new Map(), []);
/**
 * @return
 */
DB.new = function () {
    var result = vm_1.call(3651801454, []);
