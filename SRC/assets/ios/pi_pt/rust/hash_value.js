_$define("pi_pt/rust/hash_value", function (require, exports, module){
"use strict";
...
H32._$info = new sinfo_1.StructInfo("pi_pt/rust/hash_value/.H32", 961528204, new Map(), []);
/**
 * @param buf:&[u8]
...
H48._$info = new sinfo_1.StructInfo("pi_pt/rust/hash_value/.H48", 209715136, new Map(), []);
/**
 * @param buf:&[u8]
 * @return hash_value::H48
 */
...
H160._$info = new sinfo_1.StructInfo("pi_pt/rust/hash_value/.H160", 536126312, new Map(), []);
/**
 * @param buf:&[u8]
...
H256._$info = new sinfo_1.StructInfo("pi_pt/rust/hash_value/.H256", 2448676432, new Map(), []);
/**
 * @param buf:&[u8]
...
H512._$info = new sinfo_1.StructInfo("pi_pt/rust/hash_value/.H512", 154771902, new Map(), []);
/**
 * @param buf:&[u8]
...
H520._$info = new sinfo_1.StructInfo("pi_pt/rust/hash_value/.H520", 1610417349, new Map(), []);
/**
 * @param buf:&[u8]
 * @return hash_value::H520
 */
