_$define("pi_pt/net/rpc_r.s", function (require, exports, module){
"use strict";
...
OK._$info = new sinfo_1.StructInfo("pi_pt/net/rpc_r.OK", 3165343965, new Map([["type", "rpc"]]), []);
exports.OK = OK;
...
OK_I._$info = new sinfo_1.StructInfo("pi_pt/net/rpc_r.OK_I", 4093757769, new Map([["type", "rpc"]]), [new sinfo_1.FieldInfo("value", new sinfo_1.EnumType(sinfo_1.Type.I32), null)]);
exports.OK_I = OK_I;
...
OK_S._$info = new sinfo_1.StructInfo("pi_pt/net/rpc_r.OK_S", 317982793, new Map([["type", "rpc"]]), [new sinfo_1.FieldInfo("value", new sinfo_1.EnumType(sinfo_1.Type.Str), null)]);
exports.OK_S = OK_S;
...
Error._$info = new sinfo_1.StructInfo("pi_pt/net/rpc_r.Error", 2234887301, new Map([["type", "rpc"]]), [new sinfo_1.FieldInfo("code", new sinfo_1.EnumType(sinfo_1.Type.I32), null), new sinfo_1.FieldInfo("info", new sinfo_1.EnumType(sinfo_1.Type.Str), null)]);
exports.Error = Error;
...
Req._$info = new sinfo_1.StructInfo("pi_pt/net/rpc_r.Req", 603254023, new Map([["type", "rpc"]]), [new sinfo_1.FieldInfo("path", new sinfo_1.EnumType(sinfo_1.Type.Str), null)]);
exports.Req = Req;
})