_$define("earn/server/rpc/session_rpc.c", function (require, exports, module){
"use strict";
...
var arr = [[0, _$c("earn/server/rpc/session.auto_login", new Map([["rpc", "rpcServer"]]))], [1, _$c("earn/server/rpc/session.getToken", new Map([["rpc", "rpcServer"]]))]];
