_$define("earn/editor/edit/compEditor", function (require, exports, module){
"use strict";
...
var cfgMap_1 = require("../../client/app/store/cfgMap");
var tools_1 = require("../../client/app/utils/tools");
...
var CompEditor = function (_widget_1$Widget) {
    ...
    _createClass(CompEditor, [{
        ...
        value: function initData() {
            ...
            getCompetitions().then(function (res) {
...
// 新增比赛
var addCompetition = function addCompetition(team1Name, team2Name, matchType, time, team1Num, team2Num) {
    return new Promise(function (resolve, reject) {
...
// 添加比赛结果
var _addResult = function _addResult(winTeam, cid) {
    return new Promise(function (resolve, reject) {
...
// 结算比赛
var _settleGuessing = function _settleGuessing(cid) {
    return new Promise(function (resolve, reject) {
...
// 取消比赛 退回下注额
var _cancelGuessing = function _cancelGuessing(cid) {
    return new Promise(function (resolve, reject) {
