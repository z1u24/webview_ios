_$define("earn/editor/edit/test", function (require, exports, module){
"use strict";
...
// ================================================ 导入
// 编辑比赛
exports.competitionEditor = function () {
    root_1.popNew('earn-editor-edit-compEditor');
};
// 编辑商品
exports.pruductEditor = function () {
    root_1.popNew('earn-editor-edit-convertEditor');
};
...
// 订单查询
exports.orderQuery = function () {
    var oid = '1548750027447448255';
...
exports.delete_product_test = function () {
    init_1.clientRpcFunc(test_p_1.delete_test, null, function (r) {
        console.log(r);
    });
};
var props = {
    bts: [{
        name: '添加比赛',
        func: function func() {
            exports.competitionEditor();
        }
    }, {
        name: '编辑商品',
        func: function func() {
            exports.pruductEditor();
        }
    }, {
        name: '登陆',
        func: function func() {
